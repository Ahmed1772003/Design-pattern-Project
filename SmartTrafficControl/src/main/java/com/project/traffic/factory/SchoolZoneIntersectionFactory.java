...
public class SchoolZoneIntersectionFactory implements IntersectionFactory {
    @Override
    ...
    @Override
    public int getSpeedLimitKmh() { return 30; }

    @Override
    public String getName() { return "School Zone Intersection"; }
}
